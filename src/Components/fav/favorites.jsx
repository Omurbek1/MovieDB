...
export function AddFavorites({ id }) {
    ...
    return (
        <div className='mb-4'> {isfavorite ? <input type="submit" value="Добавить в избранное" onClick={HandleAdd} className="btn btn-success" /> :
            <input type="submit" value="Удалить из избранного" onClick={Handledelete} className="btn btn-danger" />}</div>
    );
...
export function ShowFavs() {
    ...
    return (<>
        <h2 className="ml-3"><i class="fas fa-folder-open"></i>Мои любимые</h2>
        {movieDetails.length > 0 ?
            ...
            <div className="d-flex justify-content-center h-100 " style={{ fontSize: "1.4rem" }}>
                <div>
                    <p ><i class="far fa-folder-open"></i> У вас пока нет фаворитов.</p>
                    <p><i class="fas fa-search"></i> Найдите фильм и нажмите «Добавить в избранное».</p></div></div>
        }
