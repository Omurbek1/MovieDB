                ...
                <div className="d-flex align-items-center justify-content-end mb-3">
                    ...
                    <form className="d-flex form-group" onSubmit={(e) => { e.preventDefault(); filterMovies() }} method="post">
                        <input className="form-control" type="number" name="Year" id="year" min="1888"
                            placeholder="Год выпуска" onChange={(e) => setFilterValue(e.target.value)} value={filterValue} pattern="\d*" />
                        <input type="submit" className="btn btn-success ml-2" value="Применить фильтр" />
